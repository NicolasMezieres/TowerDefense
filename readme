But du jeu:
-Empecher les créature d'atteindre votre coeur.
-Si 5 créatures atteigne votre coeur ![screenshot](https://github.com/NicolasMezieres/TowerDefense/blob/main/image/heart100.png?raw=true) , vous perdez la partie.
